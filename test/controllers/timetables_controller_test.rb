...
class TimetablesControllerTest < ActionController::TestCase
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post :create, timetable: { day_end_time: @timetable.day_end_time, day_start_time: @timetable.day_start_time, name: @timetable.name, slot_unit_size: @timetable.slot_unit_size, start_day_weekly: @timetable.start_day_weekly }
    end
  ...
  test "should update timetable" do
    patch :update, id: @timetable, timetable: { day_end_time: @timetable.day_end_time, day_start_time: @timetable.day_start_time, name: @timetable.name, slot_unit_size: @timetable.slot_unit_size, start_day_weekly: @timetable.start_day_weekly }
    assert_redirected_to timetable_path(assigns(:timetable))
  end
